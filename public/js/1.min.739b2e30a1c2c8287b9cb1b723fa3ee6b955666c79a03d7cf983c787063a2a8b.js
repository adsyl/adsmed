                    ...
                    <div class="space-y-8 text-gray-300 text-sm leading-relaxed">
                        <div>
                            <p class="text-white font-bold mb-2 flex items-center">
                                <span class="w-1 h-1 bg-rose-500 rounded-full mr-2"></span> 卵巢储备评估 (年龄: ${n.age}岁 / AFC: ${n.afc})
                            </p>
                            <p class="pl-3 border-l border-gray-700">${S(n.age)} ${getAfcDesc(n.afc)}</p>
                        </div>
                        <div>
                            <p class="text-white font-bold mb-2 flex items-center">
